...
{
   fileName = $defaultGame @ "/art/sound/orc_death";
...
{
   fileName = $defaultGame @ "/art/sound/orc_pain";
   description = AudioClose3d;
   preload = true;
};
...
{
   filename    = $defaultGame @ "/art/sound/lgtStep_mono_01";
...
{
   filename    = $defaultGame @ "/art/sound/hvystep_ mono_01";
   description = AudioClose3d;
   preload = true;
};
...
{
   filename    = $defaultGame @ "/art/sound/metalstep_mono_01";
   description = AudioClose3d;
   preload = true;
};
...
{
   filename    = $defaultGame @ "/art/sound/snowstep_mono_01";
   description = AudioClosest3d;
   preload = true;
};
...
{
   filename    = $defaultGame @ "/art/sound/waterstep_mono_01";
   description = AudioClose3d;
   preload = true;
};
...
datablock ParticleData(PlayerSplashMist)
{
   ...
   spinRandomMin        = -90.0;
   spinRandomMax        = 500.0;
   textureName          = $defaultGame @ "/art/shapes/actors/common/splash";
...
datablock ParticleData(PlayerFoamParticle)
{
   ...
   spinRandomMin        = -90.0;
   spinRandomMax        = 500.0;
   textureName          = $defaultGame @ "/art/particles/millsplash01";
...
{
   textureName          = $defaultGame @ "/art/particles/wake";
   dragCoefficient     = "0.0";
...
datablock SplashData(PlayerSplash)
{
   ...
   texture = $defaultGame @ "/art/particles/millsplash01";
...
datablock ParticleData(LightPuff)
{
   ...
   times[1]      = 1.0;
   times[2] = 1.0;
   textureName = $defaultGame @ "/art/particles/dustParticle.png";
};
...
datablock ParticleData(LiftoffDust)
{
   ...
   sizes[0]      = 1.0;
   times[0]      = 1.0;
   textureName = $defaultGame @ "/art/particles/dustParticle";
};
...
datablock PlayerData(DefaultPlayerData)
{
   ...
   // Third person shape
   shapeFile = $defaultGame @ "/art/shapes/actors/mrbox/player.dts";
   cameraMaxDist = 8;
...
*/
   ...
   debrisShapeName = $defaultGame @ "/art/shapes/actors/common/debris_player.dts";
   debris = playerDebris;
