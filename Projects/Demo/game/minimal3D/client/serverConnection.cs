echo(" client/serverConnection.cs :: FIXME MINIMAL!!");

//-----------------------------------------------------------------------------
// Client : handle the server connection 
//-----------------------------------------------------------------------------
...
{
   echo ("----------- GameConnection Initial Control Object -----------");
...
{
  dEcho ("----------- GameConnection::onConnectionAccepted " SPC %this SPC "-----------");
...
function disconnectedCleanup()
{
   ...
   if( $Client::missionRunning ) { 
      clientEndMission();
      if (isFunction("onClientMissionEnd")) onClientMissionEnd();
   }
