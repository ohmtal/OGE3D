...
//-----------------------------------------------------------------------------
#include "T3D/logickingMechanics/physics/ragDoll.h"
...
//----------------------------------------------------------------------------
DefineEngineStringlyVariadicMethod( RagDoll, initRagDoll, void, 3, 3, "( ShapeBase obj )" "Initialize position of ragdoll bones from given shape object.")
{
