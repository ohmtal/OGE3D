...
DefineEngineStringlyVariadicMethod(PhysBody, reset, void, 2, 2, "")
{
	object->reset();
}

DefineEngineStringlyVariadicMethod(PhysBody, addForce, void, 3, 3, "")
{
...
DefineEngineStringlyVariadicMethod(PhysBody, setEnabled, void, 3, 3, "")
{
	int isEnabled;
