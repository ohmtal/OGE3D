...
#include "T3D/logickingMechanics/physics/physicsDummy.h"
#include "T3D/logickingMechanics/physics/physShapeDummy.h"
...
DefineEngineStringlyVariadicFunction( getPhysicsLib, const char*, 1, 1, "" )
{
