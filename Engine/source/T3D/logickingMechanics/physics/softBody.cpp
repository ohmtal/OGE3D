#pragma message("XXTH SoftBody::prepBatchRender - SoftBody implementation unfinished !!!!!!!!! ")

#ifdef GMK_SoftBody_FINISHED_BLA
...
#include "T3D/logickingMechanics/physics/softBody.h"
...
void SoftBody::setTransform(const MatrixF& mat)
{
   ...
   //XXTH need more time ... but want to test it! 
...
#endif // GMK_SoftBody_FINISHED_BLA
