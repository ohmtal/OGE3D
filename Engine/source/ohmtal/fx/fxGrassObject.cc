#pragma message(" FIXME fxGrassObject --- placeholder only at the moment!! look at T3D/fx/groundCover.*")
#pragma message(" FIXME fxGrassObject --- placeholder only at the moment!!")
#pragma message(" FIXME fxGrassObject --- placeholder only at the moment!!")
#pragma message(" FIXME fxGrassObject --- placeholder only at the moment!!")
//-----------------------------------------------------------------------------
// fxGrassObject
...
// Limitation: not more then 240k planes, 
//			   , does not use multiple lights ... should do some work on shaders
//			==> 2.30 tried adding lights but shader fails 
//					see also "//fail" and gras.frag.230fail << normalMV and diffuse was always ZERO 
...
fxGrassObject::fxGrassObject()
{
 ...
 //FIXME   m_pVBO = NULL;
   //2.30 removed mClientReplicationStarted = false;
